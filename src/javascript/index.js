...
continue_btn.onclick = () => {
  ...
  const myTimeout = setTimeout(startQuiz, 2000);
...
function showQuetions(index) {
  ...
  const que_video = document.querySelector(".que_video");
  ...
  let que_tag =
    ...
    "</span>";
  let option_video ="<video src=\"./src/gifs/"+questions[index].sinal+"\" autoplay loop muted></video>";
